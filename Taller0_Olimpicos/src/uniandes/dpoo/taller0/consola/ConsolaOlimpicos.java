...
public class ConsolaOlimpicos
{
	...
	{
		String nombreAtleta = input("Escriba el nombre del atleta del cual quiera saber su nacionalidad");
		String nombre = calculadora.pais_atleta(nombreAtleta);
		System.out.println("El pais del atleta " + nombreAtleta + " es " + nombre);
	}
